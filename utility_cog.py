...
class UtilityCog(commands.Cog):
    ...
    async def weather(self, interaction: discord.Interaction, city: str):
        ...
        try:
            ...
            await interaction.followup.send("⚠️ 天気情報を取得できませんでした。都市名を確認してください。")
    ...
    async def define(self, interaction: discord.Interaction, word: str):
        ...
        try:
            ...
            await interaction.followup.send("⚠️ 意味を取得できませんでした。")
    ...
    async def wiki(self, interaction: discord.Interaction, query: str):
        ...
        try:
            ...
            await interaction.followup.send("⚠️ 検索に失敗しました。")
